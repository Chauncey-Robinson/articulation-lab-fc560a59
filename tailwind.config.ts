...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        feather: "0 10px 30px rgba(0,0,0,0.03)",
        "feather-lg": "0 20px 60px rgba(0,0,0,0.05)",
        "tile": "0 10px 30px rgba(0,0,0,0.03)",
        "tile-hover": "0 16px 40px rgba(0,0,0,0.06)",
        "card-hover": "0 16px 40px rgba(20,24,40,0.08)",
