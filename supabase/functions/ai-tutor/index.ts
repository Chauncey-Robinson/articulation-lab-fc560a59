...
Return the lessons using the provided tool.`;
      ...
      toolChoice = { type: "function", function: { name: "create_lessons" } };
                ...
                items: {
                  ...
                  properties: {
                    ...
                    options: {
                      type: "array",
                      items: { type: "string" },
                      description: "For multiple_choice: 4 options. For true_false: ['True', 'False']. For open: empty array."
                    },
...
Return using the provided tool.`;
      ...
      toolChoice = { type: "function", function: { name: "evaluate" } };
